...
![image](https://user-images.githubusercontent.com/108659935/217601126-0fc877da-3e3c-472d-a6fc-b11d85b53bed.png)

  - 각 구장별 매장위치를 검색하여 위도 경도를 찾아서 DB에 약 400개의 데이터를 삽입함.

![image](https://user-images.githubusercontent.com/108659935/217601466-7bbb07d0-8b32-4cc5-99bd-5e1917c1b6b0.png)

  - 각 구장별 매장 위치를 카카오 API를 활용하여 커스텀하여 나타냄

![image](https://user-images.githubusercontent.com/108659935/217601578-9234508b-6a66-4a3a-8909-db66387bfbec.png)

  - 커스텀 마커를 클릭시 지도의 위치를 가운데로 옮기고 다른 마커를 다 닫아줌
...
- 최근영
    ...
    많은 시간을 데이터 수집 및 가공하는데 소비하여 다른 팀원들을 많이 못도와준 것 같다.
    ```
